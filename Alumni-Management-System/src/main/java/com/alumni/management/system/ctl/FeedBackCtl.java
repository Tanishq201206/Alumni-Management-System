...
import com.alumni.management.system.form.FeedBackForm;
import com.alumni.management.system.service.FeedBackServiceInt;
...
public class FeedBackCtl extends BaseCtl {
	...
	@GetMapping("/ctl/feedBack")
	public String display(@RequestParam(required = false) Long id, @ModelAttribute("form")FeedBackForm form,
	...
	public String submit(@Valid @ModelAttribute("form") FeedBackForm form, BindingResult bindingResult,
		...
		try {
			if (OP_SAVE.equalsIgnoreCase(form.getOperation())) {
				...
				FeedBackDTO bean = (FeedBackDTO) form.getDTO();
				if (bean.getId() > 0) {
					service.update(bean);
	...
	@RequestMapping(value = "/ctl/feedBack/search", method = { RequestMethod.GET, RequestMethod.POST })
	public String searchList(@ModelAttribute("form")FeedBackForm form,
		...
		FeedBackDTO uDto = (FeedBackDTO) session.getAttribute("FeedBack");
